...
const axiosInstance = axios.create({
    baseURL : process.env.NEXT_PUBLIC_API_URL || 'https://user-ui-y5m6.onrender.com:8080',
    headers : {     
...
const baseURL = process.env.NEXT_PUBLIC_API_URL || 'https://user-ui-y5m6.onrender.com:8080';
